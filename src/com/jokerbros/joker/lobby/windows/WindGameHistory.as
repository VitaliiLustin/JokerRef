package com.jokerbros.joker.lobby.windows 
{
	...
	import com.jokerbros.joker.lobby.items.HistoryItem;
	 ...
	 * @author JokerBros
	 */
	public class WindGameHistory extends mcWindGameHistory
	{
		private var _scrollbar:EDScrollbar;
		private var _item:Vector.<HistoryItem>;
		
		public function WindGameHistory() 
		{
			this.x = 80
			this.y = 70
		...
		public function init(e:Event = null):void
		{
			...
			Connector.send('gameHistory');
			
		}
		
		private function onClose(e:MouseEvent):void 
		{
			Facade.dispatcher.dispatch(LobbyEvent.CLOSE_WIND_HISTORY);
		}
